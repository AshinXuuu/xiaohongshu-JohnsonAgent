...
| Key | Value |
|---|---|
| `CANVA_CLIENT_ID` | `OC-AZ4VLpL4rqkO` |
| `CANVA_CLIENT_SECRET` | `cnvcaisplgDft20sEVmLHTW6qewVzrjYIClB0pHTyTMVXAlkc9235451` |
| `CANVA_REDIRECT_URI` | `https://xiaohongshu-johnson-agent.vercel.app/api/canva-callback` |

> ⚠️ 建议:跑通流程后回 Canva 后台 Regenerate Client Secret,因为现在这个已经在对话里出现过了。Regenerate 后只需要把上面 `CANVA_CLIENT_SECRET` 这一条更新成新值再 Redeploy 一次即可。
