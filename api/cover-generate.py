...
PRESERVE_PHOTO = (
    '【第一优先级 · 保持照片原样】\n'
    '本图是用户上传的真实产品照片。请在这张照片上叠加小红书封面文字与少量为文字服务的设计元素,'
    '照片本身保持原样:不要加滤镜、不要整体调色、不要改变亮度色温、不要重绘或替换产品与人物,'
    '产品的形状、结构、颜色、角度以及人物五官姿态都与原图一致。\n'
    '只在画面上叠加:三级封面文字,以及少量衬托文字的设计元素(色块、圆角卡片、贴纸、细线条、描边),'
    '这些元素不要遮挡产品主体与关键细节。\n'
    '\n'
)


# ═════════════ 文字版式池(只变化主标/副标/花字的风格·颜色·字体·排列组合)═════════════
# 每个池随机抽 3 套并发出图;模板只描述三级文字的配色/字形/描边/位置排列,
# 不改动照片本身;文字内容与"一字不差·简体"约束由 TEXT_REQUIREMENTS 统一负责。

STYLE_PROMPT_POOLS = {
    '种草氛围': [
        '【文字风格 · 冷蓝清新】\n'
        '- 主标题「{main_title}」超大粗黑体,黑色字配白色描边,置于顶部偏左,视觉中心\n'
        '- 副标题「{subtitle}」主标题正下方一行,白色字带细描边\n'
        '- 花字正文「{hua_text}」浅蓝立体描边粗体,置于画面底部作点缀\n'
        '- 可加淡蓝细线条或小色块衬托文字,不遮挡产品\n',

        '【文字风格 · 暖橙治愈】\n'
        '- 主标题「{main_title}」超大粗黑体,深棕色字配米白描边,顶部偏左\n'
        '- 副标题「{subtitle}」主标下方,深棕小字\n'
        '- 花字正文「{hua_text}」暖橙立体描边粗体,错落置于底部一侧\n'
        '- 可加米白圆点或手写感小元素衬托,不遮挡产品\n',

        '【文字风格 · 莫兰迪极简】\n'
        '- 主标题「{main_title}」粗黑体,低饱和深灰字配细描边,上部居中\n'
        '- 副标题「{subtitle}」灰调小字,主标附近\n'
        '- 花字正文「{hua_text}」放入低饱和小色块卡片,置于一角\n'
        '- 细线条分隔、留白充足,文字排版简约高级\n',

        '【文字风格 · 黑白高级】\n'
        '- 主标题「{main_title}」纯黑超大极粗黑体,顶部横向铺开\n'
        '- 副标题「{subtitle}」深灰细字,主标下方\n'
        '- 花字正文「{hua_text}」白底黑字圆角胶囊贴纸,一角点缀\n'
        '- 高对比、干净,强调文字本身的设计感\n',

        '【文字风格 · 撞色活力】\n'
        '- 主标题「{main_title}」超大粗黑体,白色描边,中上部\n'
        '- 副标题「{subtitle}」放入清爽色圆角色块卡片\n'
        '- 花字正文「{hua_text}」放入另一撞色圆角色块,活泼跳色\n'
        '- 加少量圆点/星形小元素点缀,不遮挡产品\n',
    ],
    '干货教程': [
        '【文字风格 · 知识卡片】\n'
        ...
        '【文字风格 · 蓝白专业】\n'
        '- 蓝白配色的文字方案,专业清晰\n'
        '- 主标题「{main_title}」蓝色加粗,置于上部\n'
        '- 副标题「{subtitle}」深灰小字补充\n'
        '- 花字正文「{hua_text}」以序号/要点胶囊列出\n'
        '- 细线条与图标感元素点缀(不含真实文字)\n',

        '【文字风格 · 便签手账】\n'
        '- 主标题「{main_title}」马克笔手写感粗体,醒目\n'
        '- 副标题「{subtitle}」便签小字\n'
        '- 花字正文「{hua_text}」以圈注/贴纸形式点缀\n'
        '- 加胶带、便利贴等手账小元素衬托文字,不遮挡产品\n',
    ...
    '促销爆款': [
        ...
        '【文字风格 · 橙红动感】\n'
        '- 主标题「{main_title}」微倾斜超大粗体,动感十足,橙红配色\n'
        '- 副标题「{subtitle}」胶囊色块内白字\n'
        '- 花字正文「{hua_text}」角标贴纸强调\n'
        '- 加闪电/光效等紧迫感小元素(不含真实文字)\n',
...
QUALITY_BOOST = (
    '\n【风格与质感】\n'
    '- 小红书爆款封面级审美,文字排版像专业设计师精心设计\n'
    '- 竖版 3:4 构图,产品主体清晰,文字主次分明、醒目好读\n'
    '- 照片保持自然原貌(不加滤镜),视觉重点在三级文字的设计感\n'
    '- 干净、无水印、无杂乱多余文字\n'
)
